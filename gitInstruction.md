...
Также конфликт возникнет, если мы находимся в ветке, в которую внесли изменения, а в команде укажем ветку, в которой их еще нет, ведь указывая ее, мы берем последние зафиксированные изменения.
