...
Например, если мы находимся в етке **master**, а последние изменения были внесены в ветку **add_new_branch** (тут имеется в виду название ветки, оно может быть любым), то пишем:
